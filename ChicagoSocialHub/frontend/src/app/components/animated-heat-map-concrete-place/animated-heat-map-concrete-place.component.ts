...
@Component({
  selector: 'app-animated-heat-map-concrete-place',
  templateUrl: './animated-heat-map-concrete-place.component.html',
  styleUrls: ['./animated-heat-map-concrete-place.component.css']
})
export class AnimatedHeatMapConcretePlaceComponent implements OnInit {
